...
from app.form_formatting import format_display_number, parse_display_number
from app.serialization import form_values_to_raw, vessel_inputs_to_form_values
...
def test_vessel_inputs_to_form_values_formats_large_numbers() -> None:
    ...
    assert form['purchase_price'] == '90,000,000'
    assert form['offhire_rate'] == 0.02
